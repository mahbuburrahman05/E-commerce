...
<div className="bg-[#1f628a]">
      <div className="max-w-[1220px] mx-auto border-b  text-white flex items-center justify-between px-6 py-2 text-sm font-sans">

      {/* Left Text */}
      <p className="opacity-90">Welcome to Clicon online eCommerce store.</p>
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Divider */}
        <div className="h-5 w-[1px] bg-white/40 ml-2"></div>
      </div>
    </div>
</div>
  );
